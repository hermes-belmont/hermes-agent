  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        <div className="flex gap-2 text-xs"><a href={`#/inbox?agent_id=${selectedAgent.id}`}>Inbox filtered</a><a href={`#/tracking?agent_id=${selectedAgent.id}`}>Tracking filtered</a><a href="#/briefings">Briefing sections</a></div>
