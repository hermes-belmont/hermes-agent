...
export function MaintenanceView() {
  ...
  const modalFor = (key: DestructiveKey): ModalState => {
    ...
    if (key === "updateHermes") return { key, title: "Update Hermes", body: "This will update Hermes Agent and restart the Hermes Agent service. Mission Control stays online. A snapshot will be taken first.", confirmLabel: "Update Hermes", riskLevel: "high", requirePhrase: "UPDATE HERMES" };
