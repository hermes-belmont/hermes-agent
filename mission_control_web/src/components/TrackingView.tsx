...
export function TrackingView({ agents, initialAgentId, initialItemId }: Props) {
  ...
  return <section className="space-y-5">
    <div className="flex flex-wrap items-end justify-between gap-3"><div><p className="text-xs uppercase tracking-[0.24em] text-[var(--warm-glow)]">Tracking</p><h1 className="mt-2 font-expanded text-3xl uppercase tracking-[0.08em]">Tracking</h1><p className="mt-2 text-sm text-muted-foreground">What your agents are watching</p></div><Button onClick={openAdd}><Plus className="mr-2 h-4 w-4" /> Add Item</Button></div>
