    ...
    <section className="flex flex-1 flex-col gap-4">
      ...
      <section className="rounded-2xl border border-border/70 bg-background/40 p-4">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 className="font-expanded text-base font-medium text-foreground">Identity</h2>
            <p className="mt-1 text-[11px] text-muted-foreground">Update the sidebar footer label and avatar color in real time.</p>
          </div>
